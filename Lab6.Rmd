...
[Interactive and Static Graphs found here](Lab6x.html)


Application written in R [@RCoreTeam] using the data collected from the Novel Coronavirus repository [@Dong2020]
